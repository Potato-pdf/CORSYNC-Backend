    ...
    public class AdminDbContext : DbContext
    {
        ...
        private static void SeedComercial(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ImagenProducto>().HasData(
                new ImagenProducto { Id = 1, ProductoId = 1, Orden = 1, Url = "/img/producto/01-escaneo-en-vivo.jpg", Titulo = "Escaneo en vivo", Descripcion = "La pulsera transmite el pulso y la conductancia de la piel en tiempo real mientras dura la lectura.", FechaSubida = alta },
